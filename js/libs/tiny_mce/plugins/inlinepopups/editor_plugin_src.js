	...
	tinymce.create('tinymce.plugins.InlinePopups', {
		init : function(ed, url) {
			...
			ed.onBeforeRenderUI.add(function() {
				...
				DOM.loadCSS(url + '/skins/' + (ed.settings.inlinepopups_skin || 'fixate') + "/window.css");
			});
		},
...
//			f.top -= po.y;
			...
			t._addAll(DOM.doc.body, 
				['div', {id : id, role : 'dialog', 'aria-labelledby': f.type ? id + '_content' : id + '_title', 'class' : (ed.settings.inlinepopups_skin || 'fixate') + (tinymce.isIE && window.getSelection ? ' ie9' : ''), style : 'width:100px;height:100px'}, 
			...
			if (t.count == 0 && t.editor.getParam('dialog_type', 'modal') == 'modal') {
				DOM.add(DOM.doc.body, 'div', {
					id : 'mceModalBlocker',
					'class' : (t.editor.settings.inlinepopups_skin || 'fixate') + '_modalBlocker',
...
//			cp = DOM.getPos(t.editor.getContainer());
			...
			function startMove() {
				...
				DOM.add(d.body, 'div', {
					id : 'mceEventBlocker',
					'class' : 'mceEventBlocker ' + (t.editor.settings.inlinepopups_skin || 'fixate'),
					style : {zIndex : t.zIndex + 1}
				});
